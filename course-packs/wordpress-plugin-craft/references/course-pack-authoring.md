...
- Add `model_answer` exemplars to tradeoff-heavy exercises. A good exemplar includes the expected `summary`, `work`, and `checks` fields plus `rubric_mapping`, `why_this_is_good`, `common_misses`, `revision_prompt`, and `expected_score_band`.

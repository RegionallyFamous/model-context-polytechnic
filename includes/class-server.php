	...
	public static function server_instructions(): string {
		return implode(
			...
			[
				...
				'Courses can include modules, lessons, exercises, rubrics, feedback, anonymous enrollment keys, and learning memory. This does not train model weights; it schools the active session through structured context and practice loops.',
				...
				'LLM operating rule: first orient, then call begin-course on the relevant course endpoint, preserve enrollment_key, use get-next-work for the next action, use search-course for just-in-time retrieval, and call submit-feedback when something is confusing or helpful.',
